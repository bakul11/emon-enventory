    ...
    return (
        <div className='add-product'>
            <div className="product-title mb-8">
                <h2 className='text-slate-800 text-[19px] font-semibold'>User Management</h2>
                <p className='text-gray-500 text-[14px]'>Add/Update User</p>
            </div>
            {/* add prouct form  */}
                ...
                <div className="form-submit my-20 bg-white">
                    {
                        loadding ?
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <Link href='/user' className={`bg-rose-400 text-white rounded-md p-3 text-[14px] capitalize font-medium ${loadding ? 'hidden' : 'block'}`}>
                                    <div className="flex items-center gap-1">
                                        <MdClose />
                                        cancle
                                    </div>
