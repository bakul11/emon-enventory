...
import StockCart from './(site)/StockCart';
                                        ...
                                        <table className='w-full'>
                                            <thead>
                                                <tr className='text-[14px] text-left text-slate-700 font-[100] capitalize'>
                                                    ...
                                                    <th className='border-blue-100 border-b-[1px] p-2'>Product Details</th>
                                                    ...
                                                    <th className='border-blue-100 border-b-[1px] p-2'>damage</th>
                                            ...
                                            <tbody>
                                                {
                                                    products?.filter((item) => item.productName.toLowerCase().includes(search)).map((product, index) => <StockCart product={product} index={index} />)
