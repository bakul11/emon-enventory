...
const page = ({params}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        fetch(`/api/customer/updateCustomer/${params.id}`, {
            method: 'PUT',
            headers: {
                ...
                user?.email ?
                    <div className='add-product'>
                        <div className="product-title mb-8">
                            <h2 className='text-slate-800 text-[19px] font-semibold'>Update Customers </h2>
                            <p className='text-gray-500 text-[14px]'>update your customers</p>
                        </div>
                        {/* add prouct form  */}
