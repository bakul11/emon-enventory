...
const page = () => {
    ...
    const cartInfo = localStorage.getItem('supplier-cart');
    const cart = JSON.parse(cartInfo);
    const userInfo = localStorage.getItem('supplier-invice');
                    ...
                    <div className='flex justify-between gap-2'>
                        <div className="order">
                            ...
                            <div className="address space-y-2 text-slate-800 text-[14px]">
                                <p><span className='text-gray-600 capitalize'>Supplier Name</span> : {userName}</p>
