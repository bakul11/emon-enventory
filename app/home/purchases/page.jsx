...
import PurchasesCart from './(site)/PurchasesCart';
                    ...
                    <div className="product">
                        {
                            products?.length === 0 ?
                                <div className="product-empty grid place-items-center my-12">
                                    <h2 className='text-slate-800 text-[19px] font-semibold'>Your purchases is Empty</h2>
                                    <p className='text-gray-500 text-[15px] mb-2'>Please add purchases</p>
                                    <Link href='/home/purchases/add-purchases' className='inline-block ease-in-out transition-all duration-[0.5s] hover:bg-rose-500 bg-orange-400 p-3 text-[14px] rounded-md  capitalize text-white font-medium'>
                                ...
                                <div className='show-product '>
                                    <div className="flex items-center justify-between flex-wrap gap-5">
                                        <div className="product-title">
                                            <h2 className='text-slate-800 text-[19px] font-semibold'>Purchases List</h2>
                                            <p className='text-gray-500 text-[15px]'>Manage your purchases</p>
                                        </div>
                                    ...
                                    <div className="overflow-auto lg:overflow-hidden">
                                        <table className='w-full'>
                                            ...
                                            <tbody>
                                                {
                                                    products?.filter((item) => item.productName.toLowerCase().includes(search)).map((product, index) => <PurchasesCart product={product} index={index} />)
