...
import UnitCart from './(site)/UnitCart';
                    ...
                    <div className="product">
                        {
                            product?.length === 0 ?
                                <div className="product-empty grid place-items-center my-12">
                                    <h2 className='text-slate-800 text-[19px] font-semibold'>Product Unit is Empty</h2>
                                    <p className='text-gray-500 text-[15px] mb-2'>Please add Product Unit</p>
                                    <div className="product-btn">
                                        <Link href='/home/unit/add-unit' className='inline-block ease-in-out transition-all duration-[0.5s] hover:bg-rose-500 bg-orange-400 p-3 text-[14px] rounded-md  capitalize text-white font-medium'>
                                ...
                                <div className='show-product '>
                                    <div className="flex items-center justify-between flex-wrap gap-5">
                                        <div className="product-title">
                                            <h2 className='text-slate-800 text-[19px] font-semibold'>Product Unit List</h2>
                                            <p className='text-gray-500 text-[15px]'>Manage your product unit</p>
                                        </div>
                                        <div className="product-btn">
                                            <Link href='/home/unit/add-unit' className='inline-block ease-in-out transition-all duration-[0.5s] hover:bg-rose-500 bg-orange-400 p-3 text-[14px] rounded-md  capitalize text-white font-medium'>
                                                <div className="flex items-center gap-1">
                                    ...
                                    <div className="overflow-auto lg:overflow-hidden">
                                        <table className='w-full'>
                                            ...
                                            <tbody>
                                                {
                                                    product?.filter((item) => item.title.toLowerCase().includes(search)).map((pd, index) => <UnitCart pd={pd} index={index} />)
